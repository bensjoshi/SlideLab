...
MVP approach: group consecutive frames that land on the same MIDI
pitch into a single note, and drop very short blips. Roadmap Phase 4
(Full Transcription Pipeline) replaces this with real onset detection
and rhythm quantisation.
"""
import numpy as np
